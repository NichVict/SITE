...
<h2 style="text-align:center; font-size:2.1rem; font-weight:800; color:#00ff9a; text-shadow:0 0 14px rgba(0,255,154,0.55); margin-bottom:1rem;">
A Lenda da Phoenix — O Renascimento da Análise Técnica
</h2>

<p style="text-align:center; max-width:820px; margin:auto; color:#d7d7d7; font-size:1.15rem; line-height:1.6;">
Tudo o que existe hoje na análise de mercado nasceu da genialidade de cinco mentes extraordinárias:
...
<p style="text-align:center; max-width:820px; margin:1.3rem auto; color:#bbbbbb; font-size:1.05rem; line-height:1.6;">
Genialidade absoluta. Mas todos tinham uma limitação inevitável: <strong>a velocidade humana</strong>.  
Nenhum deles poderia analisar centenas de ativos simultaneamente ou recalcular risco em segundos.
</p>

<h3 style="text-align:center; color:#ff7a1a; font-size:1.75rem; font-weight:700; margin-top:2rem; text-shadow:0 0 12px rgba(255,122,26,0.45);">
A Phoenix Strategy é a evolução que eles nunca tiveram tempo de ver.
</h3>

<p style="text-align:center; max-width:820px; margin:1.2rem auto; color:#d7d7d7; font-size:1.1rem; line-height:1.7;">
...
Ela monitora, compara, filtra e entrega oportunidades claras, com a disciplina que só uma máquina consegue manter.
</p>

<p style="text-align:center; max-width:820px; margin-top:1.2rem; color:#00ff9a; font-size:1.25rem; font-weight:700; text-shadow:0 0 14px rgba(0,255,154,0.55);">
Se a análise técnica fosse inventada hoje, ela nasceria assim.
</p>

<p style="text-align:center; max-width:820px; margin-top:0.8rem; color:#ffffff; font-size:1.15rem; font-weight:600;">
